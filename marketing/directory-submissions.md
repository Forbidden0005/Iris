...
Submit starting launch day. Most directories approve within 24-72 hours.
...
- [ ] **There's An AI For That** — https://theresanaiforthat.com/submit/
  ...
  - Description: Multi-agent AI coding platform. 20+ specialist agents, 6 coding engines, parallel execution. You're the PM, agents are engineers.

- [ ] **Futurepedia** — https://www.futurepedia.io/submit-tool
  - Category: Code / Developer
  - Emphasize: open source, multi-model, local-first

- [ ] **Toolify.ai** — https://www.toolify.ai/submit
  - Category: AI Coding Tools
  - Emphasize: 29 models at 100/100, execution quality engine
...
- [ ] **AlternativeTo** — https://alternativeto.net/
  ...
  - Key differentiator: multi-agent, multi-engine, open source

- [ ] **Product Hunt** — see product-hunt.md
  - Tuesday or Wednesday launch

- [ ] **Hacker News** — see show-hn-post.md
  - Tuesday 10am ET
