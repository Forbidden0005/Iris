/**
 * Retry Manager — consolidates auto-retry logic for iris-lead
...
export function shouldRetryPlan(taskId, from, content) {
  const isCoderAgent = /iris-coder|iris-frontend|iris-fixer|iris-ml|iris-coder-back|iris-coder-front/.test(from);
  const didWork = /@@WRITE_FILE|@@RUN_CMD|wrote|created|updated|fixed|patched|done\.|complete/i.test(content);
