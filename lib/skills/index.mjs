 ...
 *   1. JSON skill files  (~/.iris/skills/<name>.json)
 *   2. SKILL.md folders  (~/.iris/skills/<name>/SKILL.md)  (ClawHub-compatible)
 *
...
const PENDING_SKILLS_FILE = path.join(os.homedir(), ".iris", "pending-skills.json");
