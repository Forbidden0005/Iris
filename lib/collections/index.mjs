 ...
 * 
 * Wraps the existing TF-IDF search (iris-cli/src/collections/index.ts)
 * and adds SQLite persistence + structured metadata filtering.
 * 
 * Use cases:
 * - iris: projects, documentation, tools, agent memory
...
export function getCollectionsDbPath() {
  return join(homedir(), '.iris', 'collections.db');
}
