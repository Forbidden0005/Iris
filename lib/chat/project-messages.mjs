 ...
 * - iris-lead dashboard chat (with projectId)
 * - CLI chat sessions (iris chat, iris exec)
 * - Sub-agent completions (iris-coder, iris-qa, etc.)
 * - Direct agent chat (via /api/chat-agent)
 * 
 * Storage: ~/.iris/project-messages/{projectId}/messages.jsonl
