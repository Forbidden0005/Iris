...
export function getSharedChatPromptOverlay(agentId = "") {
  ...
  return [
    ...
    "- Valid examples: `@iris-main acknowledge this with a short reply`, `@iris-coder inspect /abs/path/app.js and report the root cause`, `@codex review this diff and summarize the risk`.",
    ...
    "- For mention-system tests or demos, prefer a direct in-channel line like `@iris-main acknowledge this with a short reply` instead of `@@DISPATCH`.",
    "- Do not just describe how mentions work when the user asked you to use them; actually send the `@participant` line.",
    `- Other participants may still be mentioned in-channel (\`@iris-*\`, ${CLI_PARTICIPANTS.join(", ")}), but plain mentions do not by themselves authorize hidden routing.`,
