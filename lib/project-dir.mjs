...
const CONFIG_PATH = join(homedir(), ".iris", "iris.json");
...
export function getProjectDir(fallback) {
  if (process.env.IRIS_OUTPUT_DIR) return process.env.IRIS_OUTPUT_DIR;
  if (process.env.IRIS_OPENCODE_PROJECT) return process.env.IRIS_OPENCODE_PROJECT;
  try {
