...
const CLI_PROCESS_LOG = join(homedir(), ".iris", "logs", "cli-processes.jsonl");
const CLI_PROCESS_STATE = join(homedir(), ".iris", "cli-process-state.json");

try { mkdirSync(join(homedir(), ".iris", "logs"), { recursive: true }); } catch { /* read-only homedir */ }
