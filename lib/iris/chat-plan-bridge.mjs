/**
 * Chat → Plan bridge — helper only, NOT wired into crew-lead yet.
 *
 ...
 *
 * Deliberately NOT imported by any lib/crew-lead/* file. Wiring "user sends
 * a coordination-shaped chat message" to an actual call of
 * createDraftPlanFromChatRequest touches crew-lead chat-handling code,
 * which needs its own explicit slice/ownership handoff — see
 * docs/IRIS_CAPABILITY_MAP.md.
 */
