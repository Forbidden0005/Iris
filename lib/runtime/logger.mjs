/**
 * logger.mjs — structured log utility for iris
 *
 ...
 *   log("info",  "iris-lead", "RT connected", { port: 18889 });
 *   log("warn",  "wave-dispatcher", "queue full", { depth: 50, agent: "iris-coder" });
 ...
 * @param {string} component  e.g. "iris-lead", "wave-dispatcher", "pipeline-state"
