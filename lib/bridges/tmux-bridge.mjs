 ...
 *   IRIS_TMUX_BRIDGE=1 env var (or tmuxBridge: true in system config).
 */
...
export function detect() {
  ...
  const envFlag = process.env.IRIS_TMUX_BRIDGE;
 ...
 * @param {string} agentId - Iris agent ID (e.g. "iris-coder")
...
export function list() {
  ...
  //   %0       crewtest:0       120x29     -zsh                      iris-coder ~/Iris
