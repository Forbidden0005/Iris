...
test('hello command prints "hello" and exits with code 0', (t, done) => {
  exec('node bin/iris.js hello', (error, stdout, stderr) => {
...
test('installed invocation "iris hello" prints "hello" and exits with code 0', (t, done) => {
  exec('npm exec iris hello', (error, stdout, stderr) => {
...
test('existing command "--help" behavior is unchanged', (t, done) => {
  ...
  exec('node bin/iris.js --help', (baselineError, baselineStdout, baselineStderr) => {
    // Execute hello command (no-op for this test, just to ensure it doesn't break anything)
    exec('node bin/iris.js hello', (helloError, helloStdout, helloStderr) => {
      // Re-capture --help output after hello command
      exec('node bin/iris.js --help', (afterHelloError, afterHelloStdout, afterHelloStderr) => {
