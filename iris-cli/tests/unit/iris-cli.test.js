 ...
 * (iris-cli/src/agent/cli.ts), used by scripts/start.mjs.
 *
 * Run with: node --import tsx --test iris-cli/tests/unit/iris-cli.test.js
 */
...
describe('cli: parseCliArgs', () => {
  ...
  it('parses --project-dir override, including Windows-style paths', () => {
    const args = parseCliArgs(
      ['run', 'do the thing', '--project-dir', 'C:\\Users\\tyler\\Desktop\\Projects\\Iris\\iris-cli'],
      '/ignored'
    );
    assert.equal(args.projectDir, 'C:\\Users\\tyler\\Desktop\\Projects\\Iris\\iris-cli');
