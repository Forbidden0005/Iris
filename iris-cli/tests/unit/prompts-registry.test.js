/**
 * Unit tests for iris-cli/src/prompts/registry.ts
 *
 ...
 *
 * Run with: node --import tsx --test iris-cli/tests/unit/prompts-registry.test.js
 */
...
describe('PERSONA_PROFILES', () => {
  ...
  const expectedPersonas = [
    'iris-coder', 'iris-qa', 'iris-fixer', 'iris-pm',
    'iris-security', 'iris-main', 'iris-frontend',
  ];
...
describe('getTemplateForPersona', () => {
  it('returns executor-code-v1 for iris-coder', () => {
    assert.equal(getTemplateForPersona('iris-coder'), 'executor-code-v1');
  });

  it('returns specialist-qa-v1 for iris-qa', () => {
    assert.equal(getTemplateForPersona('iris-qa'), 'specialist-qa-v1');
  });

  it('returns specialist-pm-v1 for iris-pm', () => {
    assert.equal(getTemplateForPersona('iris-pm'), 'specialist-pm-v1');
  });
