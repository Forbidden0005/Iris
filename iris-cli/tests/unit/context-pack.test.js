/**
 * Unit tests for iris-cli/src/pipeline/context-pack.ts
 *
...
describe('ContextPackManager', () => {
  ...
  it('createPack writes cache file to .iris/context-packs/', () => {
    const mgr = new ContextPackManager();
    mgr.createPack('trace-1', makeArtifacts());
    const cacheDir = join(testDir, '.iris', 'context-packs');
