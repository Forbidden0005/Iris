...
export IRIS_L2A_MODEL="gpt-5.2"
export IRIS_L2B_MODEL="gpt-5.2"
export IRIS_REASONING_MODEL="gpt-5.2"
export IRIS_JSON_REPAIR_MODEL="gpt-5.2"
export IRIS_EXECUTION_MODEL="gemini-2.5-flash"
