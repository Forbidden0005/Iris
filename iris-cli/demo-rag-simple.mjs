...
console.log('Testing on iris-cli codebase itself...\n');

// Test in iris-cli directory
const testQueries = [
...
console.log('  IRIS_RAG_TOKEN_BUDGET=8000');
console.log('  IRIS_RAG_MAX_FILES=10');
console.log('\nUsage:');
console.log('  iris exec "add rate limiting to auth"');
