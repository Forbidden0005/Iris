...
const OUTPUT_DIR = '/tmp/iris-test-output';
...
console.log('1️⃣  Running iris headless run with output directory...\n');

try {
  // Run iris headless run with output directory
  const cmd = `node dist/iris.mjs headless run ${OUTPUT_DIR} --task "Create a simple Express TODO API" --always-approve --force-auto-apply`;
