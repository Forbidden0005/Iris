 ...
 * 
 * Usage: 
 *   export IRIS_USE_UNIFIED_ROUTER=true
 *   export IRIS_DUAL_L2_ENABLED=true
 *   export IRIS_CHAT_MODEL=groq/llama-3.1-8b-instant
 *   export IRIS_REASONING_MODEL=grok-4-1-fast-reasoning
 *   export IRIS_EXECUTION_MODEL=groq/llama-3.1-8b-instant
...
async function testPipeline() {
  ...
  console.log(`  Unified Router: ${process.env.IRIS_USE_UNIFIED_ROUTER || 'false'}`);
  console.log(`  Dual-L2 Planning: ${process.env.IRIS_DUAL_L2_ENABLED || 'false'}`);
  console.log(`  Chat Model: ${process.env.IRIS_CHAT_MODEL || 'default'}`);
  console.log(`  Reasoning Model: ${process.env.IRIS_REASONING_MODEL || 'default'}`);
  console.log(`  Execution Model: ${process.env.IRIS_EXECUTION_MODEL || 'default'}`);
  console.log('\n');
  ...
  if (failed.length === 0) {
    ...
    if (process.env.IRIS_DUAL_L2_ENABLED === 'true') {
