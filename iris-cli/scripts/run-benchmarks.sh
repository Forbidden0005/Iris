...
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║           IRIS STACK BENCHMARK SUITE                    ║"
echo "╚══════════════════════════════════════════════════════════════╝"
echo ""
...
if [ $missing -gt 0 ]; then
  ...
  echo ""
  echo "💡 TIP: Use test-with-config.mjs to auto-load keys from ~/.iris/iris.json"
  echo "   node scripts/test-with-config.mjs"
  echo ""
else
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "💡 Quick benchmark (auto-loads keys from iris.json):"
echo "   node scripts/test-with-config.mjs"
