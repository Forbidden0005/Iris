...
- Unit 1: Backend API (iris-coder-back persona) - Create src/api/search.js with search endpoint
- Unit 2: Frontend UI (iris-coder-front persona) - Create public/search.html with search bar and filters
- Unit 3: Tests (iris-qa persona) - Create tests/search.test.js with unit tests
...
async function runTask() {
  ...
  process.env.IRIS_CHAT_MODEL = 'groq/llama-3.1-8b-instant';
  process.env.IRIS_REASONING_MODEL = 'grok-4-1-fast-reasoning';
  process.env.IRIS_EXECUTION_MODEL = 'groq/llama-3.1-8b-instant';

  console.log('Configuration:');
  console.log(`  Output: ${OUTPUT_DIR}`);
  console.log(`  L1 (Chat): ${process.env.IRIS_CHAT_MODEL}`);
  console.log(`  L2 (Reasoning): ${process.env.IRIS_REASONING_MODEL}`);
  console.log(`  L3 (Execution): ${process.env.IRIS_EXECUTION_MODEL}`);
  console.log(`  Dual-L2: ${process.env.IRIS_DUAL_L2_ENABLED}\n`);
