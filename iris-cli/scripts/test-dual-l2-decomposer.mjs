...
const TASK = `Build the MVP (Phase 1) of a VS Code extension for Iris.
...
async function testDualL2() {
  ...
  console.log('  - iris-pm: Create architecture plan');
  console.log('  - iris-coder-back: Build extension.ts and API client');
  console.log('  - iris-coder-front: Build webview UI');
  console.log('  - iris-qa: Create tests');
  console.log('  - etc.\n');
