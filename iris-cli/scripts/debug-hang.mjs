...
async function debugHang() {
  ...
  process.env.IRIS_REASONING_MODEL = 'groq/llama-3.3-70b-versatile';
  ...
  console.log(`  L1: ${process.env.IRIS_CHAT_MODEL}`);
  console.log(`  L2: ${process.env.IRIS_REASONING_MODEL}`);
  console.log(`  L3: ${process.env.IRIS_EXECUTION_MODEL}\n`);
