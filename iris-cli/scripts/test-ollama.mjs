...
async function benchmarkOllama() {
  ...
  console.log('\n\n⚙️  CONFIGURE IRIS WITH OLLAMA\n');
  console.log('  export IRIS_USE_OLLAMA="true"');
  console.log('  export IRIS_OLLAMA_CHAT="llama3.2:3b"');
  console.log('  export IRIS_OLLAMA_REASONING="qwen2.5:7b"');
  console.log('  export IRIS_OLLAMA_EXECUTION="qwen2.5-coder:7b"');
  console.log('\n  Then run: iris repl');
}
