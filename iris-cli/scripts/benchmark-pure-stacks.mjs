...
const TASK = `Build the MVP (Phase 1) of a VS Code extension for Iris per the specs in:
- iris-cli/ide-extension/ROADMAP.md
- iris-cli/ide-extension/PDD.md
...
- src/api-client.ts (Iris API integration)
...
const STACKS = [
  {
    ...
    config: {
      IRIS_CHAT_MODEL: 'grok-4-1-fast-reasoning',
      IRIS_REASONING_MODEL: 'grok-4-1-fast-reasoning',
      IRIS_EXECUTION_MODEL: 'grok-4-1-fast-reasoning'
    }
  },
  {
    name: 'DEEPSEEK',
    ...
    config: {
      IRIS_CHAT_MODEL: 'deepseek-chat',
      IRIS_REASONING_MODEL: 'deepseek-reasoner',
      IRIS_EXECUTION_MODEL: 'deepseek-chat'
    }
  },
  {
    name: 'GEMINI',
    ...
    config: {
      IRIS_CHAT_MODEL: 'gemini-2.5-flash',
      IRIS_REASONING_MODEL: 'gemini-2.5-flash',
      IRIS_EXECUTION_MODEL: 'gemini-2.5-flash-lite'
    }
  }
];
...
async function testStack(stack) {
  ...
  console.log(`  L1 (Chat):      ${stack.config.IRIS_CHAT_MODEL}`);
  console.log(`  L2 (Reasoning): ${stack.config.IRIS_REASONING_MODEL}`);
  console.log(`  L3 (Execution): ${stack.config.IRIS_EXECUTION_MODEL}`);
