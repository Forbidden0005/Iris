...
const STACKS = [
  {
    ...
    config: {
      IRIS_CHAT_MODEL: 'groq/llama-3.1-8b-instant',
      IRIS_REASONING_MODEL: 'grok-4-1-fast-reasoning',
      IRIS_EXECUTION_MODEL: 'groq/llama-3.1-8b-instant'
    }
  },
  {
    ...
    config: {
      IRIS_CHAT_MODEL: 'groq/llama-3.1-8b-instant',
      IRIS_REASONING_MODEL: 'groq/llama-3.3-70b-versatile',
      IRIS_EXECUTION_MODEL: 'groq/llama-3.1-8b-instant'
    }
  },
  {
    ...
    config: {
      IRIS_CHAT_MODEL: 'gemini-2.5-flash-lite',
  ...
  },
  {
    ...
    config: {
      IRIS_CHAT_MODEL: 'groq/llama-3.1-8b-instant',  // Fastest
      IRIS_REASONING_MODEL: 'deepseek-reasoner',      // Best reasoning
      IRIS_EXECUTION_MODEL: 'groq/llama-3.1-8b-instant'  // Fastest
    }
  }
];
...
async function testStack(stack, timeout = 90000) {
  ...
  console.log(`Config:`);
  console.log(`  L1: ${stack.config.IRIS_CHAT_MODEL}`);
  console.log(`  L2: ${stack.config.IRIS_REASONING_MODEL}`);
  console.log(`  L3: ${stack.config.IRIS_EXECUTION_MODEL}\n`);
