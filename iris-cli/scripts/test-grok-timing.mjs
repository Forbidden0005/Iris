...
const ROADMAP = fs.readFileSync('iris-cli/ide-extension/ROADMAP.md', 'utf8');
const PDD = fs.readFileSync('iris-cli/ide-extension/PDD.md', 'utf8');

const TASK = `Build the MVP (Phase 1) of a VS Code extension for Iris per the specs in the roadmap.
