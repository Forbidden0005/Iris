...
// Note: This script uses the Iris CLI's UnifiedPipeline
...
console.log('  $ export IRIS_USE_UNIFIED_ROUTER="true"');
console.log('  $ export IRIS_DUAL_L2_ENABLED="true"');
console.log('  $ export IRIS_CHAT_MODEL="groq-llama"         # Or your L1 choice');
console.log('  $ export IRIS_REASONING_MODEL="groq-llama"    # Or your L2 choice');
console.log('  $ export IRIS_EXECUTION_MODEL="groq-llama"    # Or your L3 choice\n');

console.log('STEP 3: Test in REPL with timing');
console.log('  $ iris repl --mode builder\n');
...
TASKS.forEach((t, i) => {
  ...
  console.log(`   iris(builder)> ${t.task}`);
  console.log(`   iris(builder)> /trace     # Check execution path`);
