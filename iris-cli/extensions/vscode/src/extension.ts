...
export function activate(context: vscode.ExtensionContext) {
  ...
  statusBarItem.text = "$(sync~spin) iris";
  statusBarItem.tooltip = "iris AI Assistant";
  statusBarItem.command = "iris.openChat";
  statusBarItem.show();
  ...
  const disposable = vscode.commands.registerCommand('iris.openChat', async () => {
