# Contributing to iris-cli

Thank you for your interest in improving `iris-cli`! 
...
This uses `esbuild` to bundle the application into a single ES module `dist/iris.mjs`.
