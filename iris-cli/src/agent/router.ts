...
export class AgentRouter extends EventEmitter {
  ...
  getDefaultAgents() {
    return [
      { name: 'iris-coder', role: 'Full Stack Coder', status: 'unknown' },
      { name: 'iris-qa', role: 'Quality Assurance', status: 'unknown' },
      { name: 'iris-main', role: 'Coordinator', status: 'unknown' },
      { name: 'iris-fixer', role: 'Bug Fixer', status: 'unknown' },
      { name: 'iris-frontend', role: 'Frontend Specialist', status: 'unknown' },
      { name: 'iris-coder-back', role: 'Backend Specialist', status: 'unknown' }
    ];
  }
  ...
  getAgentRole(agentName) {
    const roles = {
      ...
      'iris-pm': 'Product Manager',
      'iris-security': 'Security Auditor',
      'iris-copywriter': 'Content Writer'
    };
