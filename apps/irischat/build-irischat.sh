#!/bin/bash
# irischat.app Build Script
# Compiles IrisChat.swift into a standalone macOS app
...
<dict>
    ...
    <string>irischat</string>
    <key>CFBundleIconFile</key>
    <string>AppIcon</string>
    <key>CFBundleIdentifier</key>
    <string>com.iris.irischat</string>
    ...
    <string>irischat needs microphone access to record voice messages</string>
    <key>NSPhotoLibraryUsageDescription</key>
    <string>irischat needs photo library access to select images for analysis</string>
</dict>
</plist>
EOF
...
echo "   or from SwiftBar: open irischat://"
echo ""
echo "🔧 Features:"
echo "   • Mode picker for iris-lead, direct CLIs, and specialist agents"
