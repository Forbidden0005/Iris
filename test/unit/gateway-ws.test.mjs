...
function makeDeps(overrides = {}) {
  ...
  return {
    ...
    IRIS_RT_URL: "ws://localhost:9999",
    IRIS_RT_TLS_INSECURE: false,
    IRIS_RT_TOKEN: "tok-test",
    GATEWAY_URL: "ws://localhost:8888",
    PROTOCOL_VERSION: 1,
    REQUEST_TIMEOUT_MS: 5000,
    CHAT_TIMEOUT_MS: 5000,
    IRIS_RT_AGENT: "test-agent",
    IRIS_RT_CHANNELS: ["events", "status"],
    IRIS_RT_RECONNECT_MS: 100,
