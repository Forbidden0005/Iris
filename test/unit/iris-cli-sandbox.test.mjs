/**
 * Unit tests for lib/engines/iris-cli-sandbox.mjs
 *
 * Only tests the exported function: runCrewCLIWithSandbox
 * Since the function spawns iris-cli (requires binary), we test:
...
const { runCrewCLIWithSandbox } = await import("../../lib/engines/iris-cli-sandbox.mjs");

describe("iris-cli-sandbox — runCrewCLIWithSandbox", () => {
